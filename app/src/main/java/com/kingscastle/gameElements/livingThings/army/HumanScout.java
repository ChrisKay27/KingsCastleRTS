...
public class HumanScout extends BasicRangedSoldier
{
	...
	static
	{
		...
		STATIC_ATTACKER_ATTRIBUTES.setAttackRangeSquared(25000 * dp * dp);
		STATIC_ATTACKER_ATTRIBUTES.setDamage( 10 );  STATIC_ATTACKER_ATTRIBUTES.setdDamageAge( 0 ); STATIC_ATTACKER_ATTRIBUTES.setdDamageLvl( 2 );
