...
public class ViewAnimatorHelper {
    ...
    public static void grow(@NonNull final View v, int growTime, @Nullable Animator.AnimatorListener listener  ){
    ...
    public static void slideToBottomOfScreen(@NonNull final View v, int screenHeight, int slideTime, @Nullable Animator.AnimatorListener listener  ){
