...
//                .build();
        ...
        setContentView(com.kaebe.kingscastle.R.layout.activity_game);

        if (tdg == null)
            tdg = new Game(this, (AndroidFastRenderView) findViewById(com.kaebe.kingscastle.R.id.surfaceView), levelClassName, diff);

        tdg.onCreate(this, (AndroidFastRenderView) findViewById(com.kaebe.kingscastle.R.id.surfaceView));
